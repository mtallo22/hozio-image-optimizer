...
define('HOZIO_IMAGE_OPTIMIZER_VERSION', '1.7.13');
define('HOZIO_IMG_VERSION', '1.7.13'); // For updater compatibility
...
class Hozio_Image_Optimizer {
    ...
    private function load_dependencies() {
        ...
        require_once __DIR__ . '/includes/class-frontend-crawler.php';
